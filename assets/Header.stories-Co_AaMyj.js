import{f as a}from"./index-DQLiMaGX.js";import{_ as o}from"./Header-D4NiFpVk.js";import"./vue.esm-bundler-Bf_jm7i3.js";import"./Button-DZsvkwqu.js";const f={title:"Example/Header",component:o,render:p=>({components:{MyHeader:o},setup(){return{args:p}},template:'<my-header :user="args.user" />'}),parameters:{layout:"fullscreen"},args:{onLogin:a(),onLogout:a(),onCreateAccount:a()},tags:["autodocs"]},e={args:{user:{name:"Jane Doe"}}},r={args:{user:null}};var s,n,t;e.parameters={...e.parameters,docs:{...(s=e.parameters)==null?void 0:s.docs,source:{originalSource:`{
  args: {
    user: {
      name: 'Jane Doe'
    }
